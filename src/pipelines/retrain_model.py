...
def retrain_model():
    ...
    try:
        ...
        logger.info("\n2️⃣ Fetching data from feature store...")
        ...
        logger.info("\n8️⃣ Saving to MongoDB model registry...")
